...
<head>
    ...
    <title>Login Admin - Sistem Analisis Beban Kerja Pegawai</title>
        ...
        <form method="POST" action="/login-admin" id="loginForm">
            ...
            <div class="text-center">
                <a href="/login-pegawai">
                    <i class="fas fa-user me-1"></i>Login sebagai Pegawai
                </a>
            </div>
        </form>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            allButtons.forEach((btn, index) => {
                btn.addEventListener('click', function(e) {
                    console.log(`Admin button ${index} clicked:`, this.textContent.trim());
                });
            });
        });
    </script>
